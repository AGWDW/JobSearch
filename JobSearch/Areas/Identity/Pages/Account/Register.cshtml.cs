...
namespace JobSearch.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private JobSearchUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<JobSearchUser>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(JobSearchUser)}'. " +
        ...
        private IUserEmailStore<JobSearchUser> GetEmailStore()
        {
            ...
            return (IUserEmailStore<JobSearchUser>)_userStore;
        }
    }
}
