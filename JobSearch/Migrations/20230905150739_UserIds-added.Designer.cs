...
namespace JobSearch.Migrations
{
    ...
    [Migration("20230905150739_UserIds-added")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobSearch.Areas.Identity.Data.JobSearchUser", b =>
                {
                    b.HasOne("JobSearch.Models.Employer", "Employer")
                        .WithOne("JobSearchUser")
                        .HasForeignKey("JobSearch.Areas.Identity.Data.JobSearchUser", "EmployerID");

                    b.HasOne("JobSearch.Models.JobSeeker", "JobSeeker")
                        .WithOne("JobSearchUser")
                        .HasForeignKey("JobSearch.Areas.Identity.Data.JobSearchUser", "JobSeekerID");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("JobSearch.Areas.Identity.Data.JobSearchUser", null)
                        .WithMany()
